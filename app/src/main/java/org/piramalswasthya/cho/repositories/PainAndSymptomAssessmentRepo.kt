        ...
        return withContext(Dispatchers.IO) {
            ...
            unsyncedList.forEach { assessment ->
                ...
                if (patient?.beneficiaryID != null && patient.beneficiaryRegID != null) {
                    networkList.add(PainAssessmentNetwork(patient.beneficiaryID.toString(), patient.beneficiaryRegID.toString(), assessment))
                }
            }
    ...
    suspend fun pullPainVisitsFromServer(): Boolean {
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                return@withContext pullPainVisitsFromServer()
            } catch (e: Exception) {
